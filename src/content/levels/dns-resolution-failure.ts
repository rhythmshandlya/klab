...
export const dnsResolutionFailure = {
  ...
  constraints: [
    { id: "edit-orders", label: "Only edit orders-api.yaml" },
    { id: "no-renames", label: "Do not rename any Service" },
  ],
  files: [{ path: "orders-api.yaml", language: "yaml", initialValue: ORDERS_YAML }],
  readonlyFiles: [
    { path: "web.yaml", language: "yaml", value: WEB_YAML },
    { path: "orders-svc.yaml", language: "yaml", value: ORDERS_SVC_YAML },
  ],
  initialManifests: [WEB_YAML, ORDERS_SVC_YAML],
  registeredImages: [
    {
      ref: "klab/api:1.0.0",
      description: "Orders API — proxies GET / to UPSTREAM_URL and reports the result.",
    },
    {
      ref: "klab/web-app:1.0.0",
      description: "Upstream web server — /healthz 200, / 200.",
    },
  ],
  allowedCommands: [
    "kubectl get pods",
