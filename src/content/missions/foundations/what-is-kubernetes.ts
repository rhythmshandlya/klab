...
export const whatIsKubernetes: Mission = {
  ...
  coldOpen: {
    ...
    clusterNote:
      "You start with an empty cluster. By the end of Foundations it will run a real service.",
  },
  ...
  steps: [
    ...
    },
    {
      kind: "teach",
      id: "declare",
      idea: "You describe desired state in YAML. You never start containers by hand; you declare what should exist.",
      visual: { mode: "concept", variant: "control-loop", buildToStep: 1 },
    },
    {
      kind: "predict",
      id: "predict-reconcile",
      ...
      predict: {
        ...
        reveal:
          "The controller notices actual (2) ≠ desired (3) and creates a replacement. That is reconciliation.",
      },
    },
    {
      kind: "check",
        ...
        options: [
          {
            ...
            text: "status",
            correct: false,
            explain: "status is written by controllers, not you.",
          },
          {
            id: "b",
            text: "spec",
            correct: true,
            explain: "spec is your desired state; status is the observed state.",
          },
          {
            id: "c",
            text: "both equally",
            correct: false,
            explain: "You own spec; the system owns status.",
          },
        ],
      },
    },
    {
      kind: "do",
      id: "do-first-pod",
      goal: "Apply this Pod and watch it become Ready. This is your cluster's first workload.",
      files: [
        {
          path: "pod.yaml",
          initialValue:
    ...
    },
    {
      kind: "debrief",
      id: "wrap",
      summary: "You now have a running Pod in a cluster you will grow across Foundations.",
